...
import com.api.swed.estore.exception.ProductNotFoundException;
...
public class PageController {
	 ...
	 * request, HttpServletResponse response) { // Invalidates HTTP Session, then
	 * unbinds any objects bound to it. // Removes the authentication from
