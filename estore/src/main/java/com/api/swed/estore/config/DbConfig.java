 ...
 * @Configuration
 * 
 * @EnableJpaRepositories(basePackages = "com.api.swed.estore.dao") public class
 * DbConfig {
 * 
 ...
 * em.setPackagesToScan(new String[] { "com.api.swed.estore.models" });
 * em.setJpaVendorAdapter(new HibernateJpaVendorAdapter());
 * em.setJpaProperties(additionalProperties()); return em; }
 * 
 * final Properties additionalProperties() { final Properties
 * hibernateProperties = new Properties(); if
 * (env.getProperty("hibernate.hbm2ddl.auto") != null) {
 * hibernateProperties.setProperty("hibernate.hbm2ddl.auto",
 * env.getProperty("hibernate.hbm2ddl.auto")); } if
 * (env.getProperty("hibernate.dialect") != null) {
 * hibernateProperties.setProperty("hibernate.dialect",
 * env.getProperty("hibernate.dialect")); } if
 * (env.getProperty("hibernate.show_sql") != null) {
 * hibernateProperties.setProperty("hibernate.show_sql",
 * env.getProperty("hibernate.show_sql")); } return hibernateProperties; }
 * 
 * @Configuration
 * 
 * @Profile("sqlite")
 * 
 * @PropertySource("classpath:persistence-sqlite.properties") class SqliteConfig
 * { }
 * 
 * }
 */